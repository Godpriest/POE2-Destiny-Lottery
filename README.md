...
* **遊戲素材版權**：本專案中所使用之 Path of Exile 2 (PoE2) 相關遊戲圖片、圖示、名稱與世界觀素材，其智慧財產權與版權皆歸原創公司 **Grinding Gear Games (GGG)** 所有，且部分素材來源源自於https://poe2db.tw。
* **非官方聲明**：本專案為玩家社群個人開發之免費同人工具，僅供交流學習使用，無任何商業營利行為，亦與 GGG 無官方合作或贊助關係。
* **背景音樂**：背景音樂標示為 AI Music generated by Suno（頁面 footer）。

---

## 🤖 AI 協助聲明 (AI Assistance Statement)

本專案之部分前端程式碼、架構規劃與技術文件經由 **AI (Cursor / Gemini)** 輔助協助產生與除錯，最終內容均由作者審閱、測試並整合完成。
